...
def mapeamento(select):
    ...
    if select == 'Até que série seu pai, ou o homem responsável por você, estudou?':
        ...
        markdown = ("""
            **Grupo 1:** Nunca estudou.  
            **Grupo 2:** Não completou a 4ª série/5º ano do Ensino Fundamental.  
            **Grupo 3:** Completou a 4ª série/5º ano, mas não completou a 8ª série/9º ano do Ensino Fundamental.  
            **Grupo 4:** Completou a 8ª série/9º ano do Ensino Fundamental, mas não completou o Ensino Médio.  
            **Grupo 5:** Completou o Ensino Médio, mas não completou a Faculdade.  
            **Grupo 6:** Completou a Faculdade, mas não completou a Pós-graduação.  
            **Grupo 7:** Completou a Pós-graduação.  
            **Grupo 8:** Não sei dessa informação.
            """ )
